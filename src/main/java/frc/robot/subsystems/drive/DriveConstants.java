...
public class DriveConstants {
    ...
    public static final double trackWidth = Units.inchesToMeters(26.5); //FIXME
    public static final double wheelBase = Units.inchesToMeters(26.5); //FIXME
    ...
    public static final Rotation2d frontLeftZeroRotation = new Rotation2d(0.0); //FIXME
    public static final Rotation2d frontRightZeroRotation = new Rotation2d(0.0); //FIXME
    public static final Rotation2d backLeftZeroRotation = new Rotation2d(0.0); //FIXME
    public static final Rotation2d backRightZeroRotation = new Rotation2d(0.0); //FIXME

    // Device CAN IDs
    public static final int pigeonCanId = 9;

    public static final int frontLeftDriveCanId = 1; //FIXME
    public static final int backLeftDriveCanId = 3; //FIXME
    public static final int frontRightDriveCanId = 5; //FIXME
    public static final int backRightDriveCanId = 7; //FIXME

    public static final int frontLeftTurnCanId = 2; //FIXME
    public static final int backLeftTurnCanId = 4; //FIXME
    ...
    public static final double driveMotorReduction =
            (45.0 * 22.0) / (14.0 * 15.0); // MAXSwerve with 14 pinion teeth and 22 spur teeth //FIXME
